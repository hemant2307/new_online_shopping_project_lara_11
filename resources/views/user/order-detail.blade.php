                                ...
                                <div class="card-body bg-light mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-4">
                                            <!-- Heading -->
                                            <h6 class="heading-xxxs text-muted">Order Date : {{Carbon\Carbon::parse($order->created_at)->format('Y-m-d')}}</h6>
                                            <!-- Text -->
                                            <p class="mb-lg-0 fs-sm fw-bold">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-4 col-md-3 col-xl-2">
                                            ...
                                            <!-- Image not ***...working...*** -->
                                             ...
                                             @endphp
                                             @if($productImage != '')
                                            <img src="{{asset('uploads/products/large/'.$productImage->image)}}" alt="..." class="img-fluid">
                                            @else
