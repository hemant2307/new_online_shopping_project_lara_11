...
<main>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        ...
                        <img src="{{asset('front-assets/images/carousel-1-m.jpg')}}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        ...
                        <img src="{{asset('front-assets/images/carousel-3-m.jpg')}}" alt="" />
                    </picture>
    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                @if($isFeaturedProduct->isNotEmpty())
                @foreach ($isFeaturedProduct as $isFeatured )

                @php
                    $productImage = $isFeatured->product_images->first();
                @endphp

                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                        <a href="{{route('shop.product',$isFeatured->slug)}}" class="product-img">
                            @if($productImage != '')
                            ...
                            <div class="product-action">
                                <a class="btn btn-dark" href="javascript:void(0)" onclick="addToCart('{{$isFeatured->id}}')">
                                    <i class="fa fa-shopping-cart"></i> Add To Cart
                                </a>
                            </div>
                        </div>
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="product.php">{{$isFeatured->title}}</a>
                            <div class="price mt-2">
                                <span class="h5"><strong>{{$isFeatured->price}}</strong></span>
                                @if($isFeatured->compair_price > 0)
                                <span class="h6 text-underline"><del>{{$isFeatured->compair_price}}</del></span>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card product-card">
                        ...
                        <div class="card-body text-center mt-3">
                            ...
                            <div class="price mt-2">
                                ...
                                @if($isFeatured->compair_price > 0)
                                <span class="h6 text-underline"><del>{{$latestProduct->compair_price}}</del></span>
                                @endif
                            </div>
                        </div>
                    </div>
