...
<div class="content-wrapper">
				...
				<section class="content">
					<!-- Default box -->
                <form action="" method="" name="editProductForm" id="editProductForm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" id="description" cols="80" rows="8" class="summernote" placeholder="Description">
                                                    {{$product->description}}
                                                    </textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="short_description" id="short_description" cols="80" rows="8" class="summernote" placeholder="short description">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="shipping_return" id="shipping_return" cols="80" rows="8" class="summernote" placeholder="shipping andreturn">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="compair_price" id="compair_price" value="{{$product->compair_price}}" class="form-control" placeholder="Compare Price">
