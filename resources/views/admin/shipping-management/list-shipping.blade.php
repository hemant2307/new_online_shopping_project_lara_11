<!-- <a href="{{route('admin.shipping.create')}}">create shipping</a> -->
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>shipping charges country wise</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.shipping.create') }}" class="btn btn-primary">create New shipping</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group" style="width: 250px;">
                            ...
                            <div class="input-group-append">
                              ...
                              <a href="{{ route('admin.shipping.list') }}" class="btn btn-primary ml-1">Clear</a>
                            </div>
                          </div>
                    </div>
                </div>
