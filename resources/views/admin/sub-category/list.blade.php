                    ...
                    <div class="card-tools">
                        <div class="input-group input-group" style="width: 250px;">
                            ...
                            <div class="input-group-append">
                              ...
                              <a href="{{ route('admin.sub-category.list') }}" class="btn btn-primary ml-1">Clear</a>
                            </div>
                          </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td @readonly(true)>{{ $sub_category->slug }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.sub-category.delete',$sub_category->id)}}" class="text-danger w-4 h-4 mr-1">
