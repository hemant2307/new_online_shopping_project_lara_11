...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" method="" name="editSubcategoryForm" id="editSubcategoryForm">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{$sub_category->name}}" placeholder="Name">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly name="slug" id="slug" class="form-control" value="{{$sub_category->slug}}" placeholder="Slug">
                            </div>
...
$("#editSubcategoryForm").submit(function(e){
    ...
    $.ajax({
        ...
        type : "POST",
        data : $('#editSubcategoryForm').serialize(),
        dataType : "json",
